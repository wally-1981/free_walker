...
public class ProductServiceProdCustSecTest extends AbstractProductServiceTest {
    private static final Logger LOG = LoggerFactory.getLogger(ProductServiceProdCustSecTest.class);

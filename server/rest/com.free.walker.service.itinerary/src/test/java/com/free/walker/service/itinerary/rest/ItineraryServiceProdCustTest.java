...
public class ItineraryServiceProdCustTest extends AbstractItineraryServiceTest {
    private static final Logger LOG = LoggerFactory.getLogger(ItineraryServiceProdCustTest.class);

...
public abstract class AbstractProductServiceTest extends BaseConfigurationProvider {
    ...
    public void testAll() throws URISyntaxException, InterruptedException {
         ...
         */
        {
            ...
            searchCriteria.add(Introspection.JSONKeys.TEMPLATE, Introspection.JSONValues.PRODUCT_TEMPLATE_AS_INT);

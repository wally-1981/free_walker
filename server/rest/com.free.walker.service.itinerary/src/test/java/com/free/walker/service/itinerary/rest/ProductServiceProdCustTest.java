...
public class ProductServiceProdCustTest extends AbstractProductServiceTest {
    private static final Logger LOG = LoggerFactory.getLogger(ProductServiceProdCustTest.class);
